...
function promjeniJezikEN()
{
    ...
    if (nas.includes("Home")) {
        ...
        const IndexelementsArray = ["Wedding Photos", "Family Photos", "Promotional Photos", "Studio Photos", "Wedding Videos", "Promotional Videos", "Video Reels", "Prices", "Contact", "Wedding photo gallery", "Family photo gallery", "Promotional photo gallery", "Studio photo gallery", "Wedding video gallery", "Promotional video gallerya", "Video reels gallery", "Our prices for the current year", "Any questions? Feel free to reach out", "Open Gallery", "Open Gallery", "Open Gallery", "Open Gallery", "Open Gallery", "Open Gallery", "Open Gallery", "Check Prices", "Contact"];
        ...
        var p5 = "Brank is happilly married and a father to a 3 year old boy. During his free time, he enjoys the most playing with his son and spending time with his family.";
        ...
        var c2 = "All photos in full format on USB media";
        ...
        var c9 = "Photo session separately another day";
        var c10 = "Online gallery available for 6 months";
        document.getElementById("enq").innerHTML = "Send Enquiry";
